...
st.markdown(
    "Li o [último relatório econômico-financeiro da ANS](https://www.gov.br/ans/pt-br/assuntos/noticias/numeros-do-setor/ans-divulga-dados-economico-financeiros-relativos-ao-3o-trimestre-de-2024) sobre seguradoras de saúde para você não precisar ler."
)
st.text(
    " Antecipando: se você já é do mercado, não espere nenhuma análise genial sobre o mercado."
)
st.markdown(
    "Meu objetivo é trazer luz para dados que vão além de headlines de PR e trazer ao mundo a reflexão que os dados me geraram sobre o poder da coragem e [delusional self belief](https://blog.samaltman.com/how-to-be-successful) para mover o mundo para frente."
)
...
st.markdown(
    "Em 2Q23, [**compra carteira da QSaúde**](https://alice.com.br/blog/imprensa/alice-compra-carteira-clientes-qsaude/), pivota para B2B e mais que dobra 'na marra' o número de membros: ~10k para ~27k. Um ano e meio depois, a empresa cresceu ~50% e finalizou 2024, segundo Gui Azevedo (founder) com [40k membros.](https://www.linkedin.com/posts/guilherme-gui-azevedo-14807730_retrospectiva-2024-spotify-na-alice-activity-7282775874171531264-q6ox?utm_source=share&utm_medium=member_desktop)"
)
st.write(
...
st.subheader("Sami")
st.text(
    "Sami inicia operação em 2021 e vive 2 anos de crescimento acelerado. 2021 sai de 0 para ~6k beneficiários. Em 2022 mais que dobra e finaliza o ano com 15k beneficiários."
)
st.text(
    "O ritmo desacelerou significativamente em 2023 e 2024. Em 2023, a empresa cresceu 30%, terminando o ano com 21k beneficiários. 2024 tem sido ainda mais difícil — encolheu em ~300 segurados se comparado ao início do ano."
)
...
st.text(
    "Ao colocar a penetração em perspectiva, me questiono o quão longe estamos de mudanças tectônicas. É preciso mais 5/10 anos ou 20/30 anos? Mais $50 milhões ou $500 milhões? Alta dependência dos órgãos reguladores para acelerar a evolução do sistema?"
)
st.text(
    "A clareza de quão longe estamos de mudanças substanciais em termos de tempo, regulação e investimento é essencial para tirar qualquer conclusão sobre qual será a magnitude do impacto dessas startups."
)
st.text(
    "Elas serão os heróis que iniciam o movimento e morrem antes de vê-lo tomando proporções sem precedentes ou conseguirão 'endure for long enough' para criar e surfar a própria tailwind?"
)
st.divider()
...
st.text(
    "Independente de opinião, fato é que Sami e Alice tem 'mercado infinito' pela frente. Então, quão rápido elas estão capturando demanda?"
)
st.text(
...
st.text(
    "- Zoom in: 2023 foi o melhor ano desde pandemia — 17% de crescimento. Se mantivermos a sazonalidade do último ano nesse 4Q, números indicam crescimento superior a 10%, segunda melhor porformance desde 2020."
)
st.text(
    "- Titãs: desde 2020, um terço do mercado está nas mãos das top 5 seguradoras. A Hapvida é a operadora que mais cresceu nesse intervalo: +95%. Destaque de 2024 é a Amil que nos três primeiros trimestres já atingiu ~93% da receita de 2023 vs ~80% das outras quatro. Se seguir nesse velocidade, a Amil deve crescer +20% nesse ano."
)
st.caption(
...
st.write(
    "Apesar do baseline transmitir o 'general growth rate' da indústria, Alice e Sami são uma 'espécie rara' de operadora. Tech-native, VC-backed, jovens. Então, os ângulos de comparação devem ser outros."
)
...
st.text(
    "Então, uma comparação mais coerente deve ser com OMINT, Care Plus, Sul América. Planos com posicionamento premium, cobertura predominante em São Paulo, rede credenciada conceituada."
)
...
st.text(
    "Alice e Sami pertencem ao recorte de operadoras de Médio Porte (20 - 100 mil beneficiários) e modalidade Medicina de Grupo (vendem para PF e/ou PJ com rede própria ou terceirizada)."
)
